...
/* package parpriori-0.1.0.0 */
#ifndef VERSION_parpriori
#define VERSION_parpriori "0.1.0.0"
#endif /* VERSION_parpriori */
#ifndef MIN_VERSION_parpriori
#define MIN_VERSION_parpriori(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_parpriori */
...
#define CURRENT_COMPONENT_ID "parpriori-0.1.0.0-inplace-parpriori"
